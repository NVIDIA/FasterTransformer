          ...
          ffn_layernorm_gamma, ffn_layernorm_beta, inter_kernel, inter_bias, output_kernel, output_bias}
{
  ...
  switch (_st) {
    case at::ScalarType::Float:
      ftdecoder = new torch_ext::FTDecoder<float>(head_num, head_size, mem_hidden_dim, weights);
      break;
    case at::ScalarType::Half:
      ftdecoder = new torch_ext::FTDecoder<half>(head_num, head_size, mem_hidden_dim, weights);
      break;
    default:
