...
struct ParallelGptFP8TritonModel: public AbstractTransformerModel {
    ParallelGptFP8TritonModel(size_t      max_seq_len,
                              size_t      head_num,
    ...
    ParallelGptFP8TritonModel(size_t      tensor_para_size,
                              size_t      pipeline_para_size,
                              int         enable_custom_all_reduce,
                              std::string model_dir,
                              int         int8_mode);
...
private:
    ...
    std::vector<std::shared_ptr<ft::GptFP8Weight<T1, T2>>> shared_weights_;
