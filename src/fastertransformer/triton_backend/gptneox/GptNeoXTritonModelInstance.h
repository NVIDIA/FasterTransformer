...
template<typename T>
struct GptNeoXTritonModelInstance: AbstractTransformerModelInstance {

    GptNeoXTritonModelInstance(std::unique_ptr<ft::GptNeoX<T>>                         gpt,
...
private:
    const std::unique_ptr<ft::GptNeoX<T>>                         gpt_;
    const std::shared_ptr<ft::GptNeoXWeight<T>>                   gpt_weight_;
