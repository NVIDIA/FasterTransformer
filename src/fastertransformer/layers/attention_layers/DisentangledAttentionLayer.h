...
template<typename T>
class DisentangledAttentionLayer: public BaseAttentionLayer<T> {
private:
    // metadata
    size_t head_num_;
...
protected:
    ...
    T* v_buf_2_     = nullptr;
    T* qk_buf_      = nullptr;
    T* q_rel_buf_   = nullptr;
    T* k_rel_buf_   = nullptr;
    T* q_rel_buf_2_ = nullptr;
    T* k_rel_buf_2_ = nullptr;
    T* QcKr_buf_    = nullptr;
    T* KcQr_buf_    = nullptr;
    T* qkv_buf_     = nullptr;
    ...
    T** batch_qk_rel_kernel_ptr_ = nullptr;
    T** batch_qk_rel_input_ptr_  = nullptr;
    T** batch_qk_rel_buf_ptr_    = nullptr;

public:
    DisentangledAttentionLayer(size_t           max_batch_size,
                               size_t           max_seq_len,
                               size_t           head_num,
    ...
    DisentangledAttentionLayer(DisentangledAttentionLayer<T> const& attention_layer);

    ~DisentangledAttentionLayer();
