...
template void invokeTransposeMatrixCOL32ToColMajor<float>(float* dst, const float* src, const int m, const int n, cudaStream_t stream);

template void invokeTransposeMatrixCOL32ToColMajor<half>(half *dst, const half* src, const int m, const int n, cudaStream_t stream);

template void invokeTransposeMatrixCOL32ToColMajor<int8_t>(int8_t* dst, const int8_t* src, const int m, const int n, cudaStream_t stream);
...
template void invokeTransposeMatrixColMajorToCOL32<float>(float* dst, const float* src, const int m, const int n, cudaStream_t stream);

template void invokeTransposeMatrixColMajorToCOL32<half>(half *dst, const half* src, const int m, const int n, cudaStream_t stream);
...
template void invokeTransposeMatrixColMajorToCOL32Quantize<float>(int8_t* dst, const float* src, const int m, const int n, const float* scale_ptr, cudaStream_t stream);

template void invokeTransposeMatrixColMajorToCOL32Quantize<half>(int8_t *dst, const half* src, const int m, const int n, const float* scale_ptr, cudaStream_t stream);
