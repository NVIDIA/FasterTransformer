...
__global__
void add_bias_gelu_COL32_int32I_int8O(int8_t *out, const int32_t* input, const float* bias, const int m, const int n, 
...
__global__
void add_bias_gelu_COL32_int32I_int8O(char4 *out, const int4* input, const half2* bias, const int m, const int n, 
...
template <typename T>
void invokeAddBiasGeluCol32(int8_t *out, const int32_t* in, const T* bias, const int m, const int n, 
                            cudaStream_t stream, const float* weight_amax, const float* input_deQFactor_div127_ptr, 
                            const float* out_scale_ptr){
  dim3 grid(m);
  dim3 block(n/4);
  assert(block.x <= 1024);
  if (sizeof(T) == sizeof(half))
    add_bias_gelu_COL32_int32I_int8O<<<grid, block, 0, stream>>>((char4*)out, (const int4*)in, (const half2*)bias, m, n, (const float4*)weight_amax, input_deQFactor_div127_ptr, out_scale_ptr);
  else
    add_bias_gelu_COL32_int32I_int8O<<<grid, block, 0, stream>>>(out, in, (const float*)bias, m, n, weight_amax, input_deQFactor_div127_ptr, out_scale_ptr);
}

template 
void invokeAddBiasGeluCol32(int8_t *out, const int32_t* in, const float* bias, const int m, const int n, 
                            cudaStream_t stream, const float* weight_amax, const float* input_deQFactor_div127_ptr, 
                            const float* out_scale_ptr);
template 
void invokeAddBiasGeluCol32(int8_t *out, const int32_t* in, const half* bias, const int m, const int n, 
                            cudaStream_t stream, const float* weight_amax, const float* input_deQFactor_div127_ptr, 
                            const float* out_scale_ptr);
...
template <typename T>
__global__
void add_bias_gelu_COL32_int8IO(int8_t *out, const int8_t* input, const T* bias, const int m, const int n, 
...
template <typename T>
void invokeAddBiasGeluCol32(int8_t *out, const int8_t* in, const T* bias, const int m, const int n, 
...
template
void invokeAddBiasGeluCol32(int8_t *out, const int8_t* in, const float* bias, const int m, const int n, 
                            cudaStream_t stream, const float* input_deQFactor_ptr, const float* out_scale_ptr);
                            
template
void invokeAddBiasGeluCol32(int8_t *out, const int8_t* in, const half* bias, const int m, const int n, 
                            cudaStream_t stream, const float* input_deQFactor_ptr, const float* out_scale_ptr);
...
template <typename T>
__global__
void add_bias_gelu_ROW_int8IO(int8_t *out, const int8_t* input, const T* bias, const int m, const int n, 
                                const float *input_deQFactor_ptr, const float *out_scale_ptr)
{
...
template <typename T>
void invokeAddBiasGeluRow(int8_t *out, const int8_t* in, const T* bias, const int m, const int n, 
                          cudaStream_t stream, const float* input_deQFactor_ptr, const float* out_scale_ptr){
  dim3 grid(m);
  dim3 block(n/4);
  assert(block.x <= 1024);
...
template
void invokeAddBiasGeluRow(int8_t *out, const int8_t* in, const float* bias, const int m, const int n, 
                          cudaStream_t stream, const float* input_deQFactor_ptr, const float* out_scale_ptr);
                            
template
void invokeAddBiasGeluRow(int8_t *out, const int8_t* in, const half* bias, const int m, const int n, 
                          cudaStream_t stream, const float* input_deQFactor_ptr, const float* out_scale_ptr);
