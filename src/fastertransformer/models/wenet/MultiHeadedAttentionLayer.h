...
template<typename T>
class MultiHeadedAttentionLayer: public BaseAttentionLayer<T> {
private:
    // metadata
    size_t head_num_;
...
public:
    MultiHeadedAttentionLayer(size_t           max_batch_size,
                              size_t           max_seq_len,
                              size_t           head_num,
    ...
    MultiHeadedAttentionLayer(MultiHeadedAttentionLayer<T> const& attention_layer);
